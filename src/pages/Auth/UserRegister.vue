<template>
  <div class="fullscreen" >
    ...
    <div class="flex flex-center  ">
      ...
      <div  :style="[ this.$q.dark.isActive ? { 'background':'url(\'../src/assets/icons/bg-2.png\') center  no-repeat','min-height':'340px',' min-width' : '325px' } : { 'background':'url(\'../src/assets/icons/bg-img.png\') center no-repeat','min-height':'340px',' min-width' : '325px' }]">
